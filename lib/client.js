...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    // ── sidebar footer toggle (sidebar.footer.action entry; icon-only) ──────
    ...
    function apply(ctx) {
      ...
      ctx.effect(() => {
        ...
        tag.dataset.pluginCss = 'dsh-mcp-skill-manager/panel.css';
      ...
      // Fixed entry point: right of the Settings seat in the sidebar foot
      // (the floating badge was removed — it jumped with the conversation
      // column; the sidebar footer action is a stable, layout-owned seat).
